      ...
      <nav className="w-full fixed top-0 z-50 px-6 py-4">
        <div className="max-w-5xl mx-auto glass-strong rounded-2xl px-6 py-3 flex items-center justify-between">
          ...
          <div className="hidden sm:flex text-sm text-white/60 gap-6 items-center">
            ...
            <a href="https://dreeyanzz.vercel.app/" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">
              Portfolio
            </a>
          </div>
        </div>
      ...
      <footer className="relative z-10 pb-8 px-6 text-center">
        <div className="glass max-w-5xl mx-auto rounded-2xl py-5">
          ...
          <p className="text-white/20 text-xs mt-1">
            Made by <a href="https://dreeyanzz.vercel.app/" target="_blank" rel="noreferrer" className="hover:text-white/50 transition-colors underline underline-offset-2">dreeyanzz</a>
          </p>
        </div>
      </footer>
